                                ...
                                foreach ($jadwal->result_array() as $data) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'admin/Absensi/input/' . $data['kode_jadwal_pelajaran']; ?>"><span class='glyphicon glyphicon-th'></span> Tampilkan </a>
